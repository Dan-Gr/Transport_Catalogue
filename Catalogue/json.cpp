...
struct PrintContext {
    ...
    PrintContext Indented() const { return {out, indent_step, indent_step + indent}; }
};
...
void Print(const Document& doc, std::ostream& output) { PrintNode(doc.GetRoot(), PrintContext{output}); }
